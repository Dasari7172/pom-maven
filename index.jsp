...
<body>
	...
	<h1 style="color: green; font-size: 40px;" align="center">THIS IS 8.6.1</h1>
	<h1 style="color: yellow; font-size: 40px;" align="center">ButterFly ButterFlu where are you going </h1>
	<h1 style="color: yellow; font-size: 40px;" align="center">I love you</h1>
<h1 style="color: yellow; font-size: 40px;" align="center">I Hate you</h1>
